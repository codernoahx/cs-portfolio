...
def test_calculate_handlen():
    assert calculate_handlen(get_frequency_dict("python")) == 6
    assert calculate_handlen(get_frequency_dict("programming")) == 11
    assert calculate_handlen(get_frequency_dict("")) == 0
    assert calculate_handlen(get_frequency_dict("a")) == 1
    assert calculate_handlen(get_frequency_dict("abcdef")) != 5
    assert calculate_handlen(get_frequency_dict("abc1248s8298")) == 12
    assert calculate_handlen(get_frequency_dict("aaa")) == 3
    assert calculate_handlen(get_frequency_dict("ababab")) == 6
    assert calculate_handlen(get_frequency_dict("a1b2c3d5i0")) == 10
    assert calculate_handlen(get_frequency_dict("15390346")) == 8
