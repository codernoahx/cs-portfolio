...
class NewsStory(object):
    def __init__(
        self, guid: str, title: str, description: str, link: str, pubdate: datetime
    ) -> None:
        """
    ...
    def get_guid(self):
        """
        Returns guid (string): A globally unique identifier for this news story.
        """
    ...
    def get_title(self):
        """
        Returns title (string): The news story's headline.
        """
    ...
    def get_description(self):
        """
        Returns description (string): A paragraph or so summarizing the news story.
        """
    ...
    def get_link(self):
        """
        Returns link (string): A link to a website with the entire story.
        """
    ...
    def get_pubdate(self):
        """
        Returns pubdate (datetime): Date the news was published
        """
...
class TitleTrigger(PhraseTrigger):
    ...
    def evaluate(self, story: NewsStory) -> bool:
        # calling the is_phrase_in method with title passed as an argument, to check if that phrase exists
        # in the story title, it it exists return True else False
...
class DescriptionTrigger(PhraseTrigger):
    ...
    def evaluate(self, story: NewsStory) -> bool:
        # calling the is_phrase_in method with description passed as an argument, to check if that phrase exists
        # in the story description, it it exists return True else False
